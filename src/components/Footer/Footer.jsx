...
export default function Footer() {
  return (
    <footer className='footer'>
      <p className='footerText'>Desarrollado por Nico Bonder</p>
      <Link
        className='footerLink'
        target='_blank'
        to='https://www.linkedin.com/in/nicobonder/'
      >
        <svg
          fill='#fff'
      ...
      <Link
        className='footerLink'
        target='_blank'
        to='https://github.com/nicobonder/'
      >
        <svg
          fill='#fff'
          xmlns='http://www.w3.org/2000/svg'
      ...
      <Link
        className='footerLink'
        target='_blank'
        to='https://www.instagram.com/altoviajeblog/'
      >
